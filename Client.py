...
connexion_avec_serveur.num1 = float(input("Entrer le premier numéro :"))
connexion_avec_serveur.num2 = float(input("Entrer le deuxième numéro : "))
...
connexion_avec_serveur.reciv (1)
